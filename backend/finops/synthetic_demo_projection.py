    ...
    return _envelope({
        ...
        "overview": {
            ...
            "metrics": {
                ...
                "cache": {"eligible_requests": len(eligible), "hit": cache_counts["hit"], "miss": cache_counts["miss"], "bypassed": cache_counts["bypassed"], "unavailable": cache_counts["unavailable"], "avoided_tokens": 0, "estimated_savings": 0, "data_status": "synthetic_demo"},
                "apim_coverage_pct": round(governed / len(events) * 100, 4),
            },
        },
